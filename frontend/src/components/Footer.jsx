  ...
  return (
    <footer className="bg-slate-950 py-10">
        <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-slate-300 text-sm lg:text-base mt-5">&copy; 2023 Michael Uchenna HND Final Project supervise by Mr. Egesi Pascal.<br /> All Rights Reserved.</p>
        </div>
</footer>
  )
}
