          ...
          <div className='relative'>
            ...
            <div className='collapsable toggle-content transition-all duration-300 bg-white shadow rounded absolute right-2 w-32' id='profile_dropdown'>
              ...
              <div className='flex items-center gap-4 py-3 px-4'>
                <div>
                  <Link to="/my_profile" className='text-slate-400 text-sm block hover:text-primary'>
                    Profile
                  </Link>

                  <button className='text-slate-400 text-sm hover:text-primary' onClick={handleLogout}>
                    Logout
                  </button>
                </div>
              </div> 
