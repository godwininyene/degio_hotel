  ...
  return (
    <div className='bg-sky-950 h-full text-white overflow-y-auto'>
        <div className="flex-grow flex items-center  py-2">
            ...
            <h1 className='h-full -ml-2 text-lg uppercase font-medium'>BlueBell Hotel</h1>
        </div>
        ...
        <div className='bg-slate-700 min-h-[500px] pt-10'>
            ...
            {/* Check-in-out */}
            <div className='mb-3 pl-4'>
                <NavLink to="/" className={`pl-2 flex items-center border-b border-b-transparent`} style={({isActive})=> isActive ? activeStyle : null}>
