            ...
            <div className="flex justify-between items-center">
                <aside className="flex items-center justify-between w-full lg:w-auto">
                    <div className="flex-grow flex items-center">
                        ...
                        <h1 className='h-full text-3xl uppercase font-medium'>Degio Hotel</h1>
                    </div>
                </aside>
                <div className={`fixed lg:relative flex flex-col lg:flex-row bg-slate-50  lg:bg-transparent z-50  lg:left-auto top-0 h-full w-56 lg:w-auto transition-all duration-500 text-slate-900 dark:text-white`}>
                    <div className=" py-3">
